...
const Rating_box = ({title, id}) => {
  ...
  return (
    <article id={id} className={`flex flex-col gap-rating__item d:gap-rating__item--d items-center bg-lightGrayishMagenta rounded-rating__item  py-rating__item_Y d:py-rating__item_Y--d d:ps-8 d:w-rating__item d:flex-row ${place_self}`}>
